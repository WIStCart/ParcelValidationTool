...
#Create error object and run initial checks
...
reader = csv.reader(open(os.path.join(directory, 'school_district_codes.csv')))
...
reader = csv.reader(open(os.path.join(directory, 'CoNameFips.csv')))
county_nameNo_dict = {}
county_noName_dict = {}
for row in reader:
	k, v = row
...
summaryTxt = Summary()
Summary.writeSummaryTxt(summaryTxt,inputDict['outSummaryDir'],inputDict['outName'],totError)
