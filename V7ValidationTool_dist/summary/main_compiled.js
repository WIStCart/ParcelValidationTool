  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", null, React.createElement("div", {
        ...
        target: "_blank"
      }, "Explain-Certification.txt"), " file."))), React.createElement("div", {
        id: "row"
      }, React.createElement("div", {
        id: "inline",
        className: "bricks"
      ...
      }, "explain"), " each error message on this Validation_Summary_Page"), React.createElement("li", null, "Run Validation Tool in FINAL mode"), React.createElement("li", null, "Input your Explain-Certification.txt file"), React.createElement("li", null, "Save the \".ini\" file\u2014which is your *mandatory* submission form")), React.createElement("h3", {
        class: "next-steps-h3"
      }, "ZIP & SUBMIT"), React.createElement("ul", {
        className: "Pdata"
      }, React.createElement("li", null, "Submit .ini Submission Form + data")))));
    }
  }]);
    ...
    value: function list() {
      ...
      */
      ...
      //if countZero == 0 {  //when fields didn't increase or decrease considerably
        var dirString = "!!!!!! NO ATTRIBUTES WITH 15% OR GREATER INCREASE/DECREASE IN RECORD VALUE COMPLETENESS !!!!!!";
