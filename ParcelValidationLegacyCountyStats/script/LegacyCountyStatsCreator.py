...
#	3)	Use the previous version's most recent statewide version (i.e. V5.0.1).
#       When the tool completes, copy and paste the results in the console to the LegacyCountyStats.py file within the ParcelValidationTool\script directory
