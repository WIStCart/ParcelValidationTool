...
class App(ttk.Frame):    
    ...
    def create_widgets(self):
        ...
        button_main_1 = ttk.Button(self, width=25, text = "Parcel Data Information",
                                   command = self.open_parcelDataInformationWindow)
        button_main_1.grid(column=0, row=9, sticky=tk.N, pady=(20,10))

        button_main_2 = ttk.Button(self, width=25, text = "PLSS Layer", command = self.open_plssLayerWindow) 
        button_main_2.grid(column=0, row=10, sticky=tk.N, pady=10)       

        button_main_3 = ttk.Button(self, width=25, text = "Zoning Layer", command = self.open_zoningLayerWindow)
        button_main_3.grid(column=0, row=11, sticky=tk.N, pady=10)

        button_main_4 = ttk.Button(self, width=25, text = "Other Layers", command = self.open_otherLayersWindow) 
        button_main_4.grid(column=0, row=12, sticky=tk.N, pady=10)
        
        button_main_5 = ttk.Button(self, width=15, text = "Run", command = self.big_run_button) 
        button_main_5.grid(column=0, row=13, sticky=tk.N, pady=10)
        ...
        def isPLSSReadytoRun(event ):
            ...
            if typeVar[0].get() == defaultInputComparator[typeVar[1]]: 
                ...
                if typeVar[0].get() == 'Maintained by county as .shp or feature class':
                        ...
                        if (plssinputObject[0].get() == defaultInputComparator[plssinputObject[1]]) or (plssinputObject[1] == 'PLSSFC' and not arcpy.Exists(plssinputObject[0].get()) ) or (plssinputObject[1] == 'PLSSFC' and arcpy.Exists(plssinputObject[0].get()) and arcpy.Describe(plssinputObject[0].get()).dataType != 'FeatureClass' ) :
            ...
            for i in range(0,6,2):
                ...
                if typeVar[0].get() == defaultInputComparator[typeVar[1]]: 
                    ...
                    if typeVar[0].get() == 'Administered by county':
                        ...
                        if (fcVar[0].get() == defaultInputComparator[fcVar[1]]) or ( not arcpy.Exists(fcVar[0].get()) or ( arcpy.Exists(fcVar[0].get()) and arcpy.Describe(fcVar[0].get()).dataType != 'FeatureClass' ))  or (not arcpy.Exists(fcVar[0].get() ) or (arcpy.Exists(fcVar[0].get()) and arcpy.Describe(fcVar[0].get()).dataType != 'FeatureClass' )) or  ((fcVar[1] == 'zoningShoreFC' and not arcpy.Exists(fcVar[0].get())) or (fcVar[1] == 'zoningShoreFC' and arcpy.Exists(fcVar[0].get()) and arcpy.Describe(fcVar[0].get()).dataType != 'FeatureClass')): 
