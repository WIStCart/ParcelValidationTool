         ...
         <div>
             <div id="summary" className="bricks">
               ...
               <ol>
                  ...
                  <li style = {{textAlign: "left"}}><b>Explain.</b> Provide explanations in writing for any legitimately missing/non-conforming data in the <a href="https://www.sco.wisc.edu/parcels/tools/Validation/Validation_Tool_Guide.pdf#nameddest=inputting_explain_certification" target="_blank">Explain-Certification form in the User Interface</a> file.</li>
               </ol>
             </div>
             <div id="row">
            ...
            <div id="next" className="bricks">
              ...
              <h3 class="next-steps-h3 margin-h3">VALIDATE WITH VALIDATION TOOL</h3>
                <ul className="Pdata">
                  ...
                  <li>Enter explanations in the Explain-Certification form</li>
                </ul>
                <h3 class="next-steps-h3">ZIP & SUBMIT</h3>
                <ul className="Pdata">
                  <li>Zip folder with created geodatabases (PARCEL and OTHER layers) + the .ini file</li>
                </ul>
            </div>
            </div>
          </div>
