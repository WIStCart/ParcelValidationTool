...
function (_React$Component4) {
  ...
  _createClass(BroadLevelErrors, [{
    ...
    value: function list() {
      ...
      var orderArray = [["Expected_Taxroll_Year", "TAXROLLYEAR \"2022\" (Expected year value)"], ["Previous_Taxroll_Year", "TAXROLLYEAR \"2021\" (Previous year value)"], ["Future_Taxroll_Years", "TAXROLLYEAR \"2023 or 2024\" (Future year values)"], ["Other_Taxroll_Years", "TAXROLLYEAR (Other year values)"]]; // Determines the order to which the elements appear from top to bottom
