...
function getPcnt(oldNumber, newNumber) {
  if (newNumber == null) {
    ...
    return percentDifference.toLocaleString(navigator.language, {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      this.setState({
        ...
        explanations: explain // callback function for the asyncronous setState call.
    ...
    value: function render() {
      ...
      return React.createElement("div", null, React.createElement("div", {
        id: "summary",
        className: "bricks"
      }, React.createElement("h1", null, "Validation Summary Page - ", coInfo.CO_NAME.charAt(0) + coInfo.CO_NAME.slice(1).toLowerCase(), " ", React.createElement("img", {
      ...
      }, "Summary of possible errors found by the Validation Tool, for which you must:"), React.createElement("ol", null, React.createElement("li", {
        style: {
          textAlign: "left"
        }
      }, React.createElement("b", null, "Eliminate."), " Eliminate the flags. Go back to the output feature class to resolve each error by making the data consistent with the schema specs in ", React.createElement("a", {
        href: "https://www.sco.wisc.edu/parcels/Submission_Documentation.pdf",
        target: "_blank"
      }, "Submission Documentation"), ", or,"), React.createElement("li", {
        style: {
          textAlign: "left"
        }
      }, React.createElement("b", null, "Explain."), " Provide explanations in writing for any legitimately missing/non-conforming data in the ", React.createElement("a", {
        href: "https://www.sco.wisc.edu/parcels/tools/Validation/Validation_Tool_Guide.pdf#nameddest=inputting_explain_certification",
        target: "_blank"
      }, "Explain-Certification"), " form of the User Interface."))), React.createElement("div", {
        id: "row"
      }, React.createElement("div", {
        id: "inline",
        className: "bricks"
        ...
        id: "next",
        className: "bricks"
      }, React.createElement("h2", null, "NEXT STEPS"), React.createElement("h3", {
        class: "next-steps-h3 margin-h3"
      }, "VALIDATE WITH VALIDATION TOOL"), React.createElement("ul", {
        className: "Pdata"
      }, React.createElement("li", null, "Work to either ", React.createElement("b", {
        style: {
          color: "#000000"
        }
      }, "eliminate"), " or ", React.createElement("b", {
        style: {
          color: "#000000"
        }
      }, "explain"), " each error message on this Validation_Summary_Page"), React.createElement("li", null, "Run Validation Tool in FINAL mode"), React.createElement("li", null, "Enter explanations in the Explain-Certification form")), React.createElement("h3", {
        class: "next-steps-h3"
      }, "ZIP & SUBMIT"), React.createElement("ul", {
        className: "Pdata"
      }, React.createElement("li", null, "Zip folder with created geodatabases (PARCEL and OTHER layers) + the .ini file")))));
    }
  }]);

  return App;
}(React.Component); //This component renders the "more" information above the chart.
...
function (_React$Component2) {
  ...
  function FieldsList() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FieldsList).apply(this, arguments));
  }
      ...
      for (var g in schemaOrder) {
        ...
        if (f.hasOwnProperty(schemaOrder[g]) & Math.abs(f[i]) >= 15) {
          ...
          tableArray.push(React.createElement("tr", {
            ...
            href: "https://www.sco.wisc.edu/parcels/Submission_Documentation.pdf#nameddest=" + i.toLowerCase(),
            target: "_blank",
            style: {
              fontWeight: 'bold',
              padding: '3px'
          ...
          }, valueString)), React.createElement("td", {
  ...
  },
  {
    ...
    value: function render() {
      ...
      var first = array.slice(0, array.length); //var second = array.slice(m, array.length)

      var tableHeader = [React.createElement("th", {
        style: fieldStyle
      }, React.createElement("a", {
        style: {
          padding: '3px'
      ...
      }, tableHeader[0], tableHeader[1], first));
    }
  }]);

  return FieldsList;
}(React.Component); //This component renders the list of inline errors items and sets up a tooltip on them to render on click.
...
function (_React$Component3) {
  ...
  function InLineErrors() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(InLineErrors).apply(this, arguments));
  }
  ...
  _createClass(InLineErrors, [{
    ...
    value: function render() {
      return React.createElement("div", null, React.createElement("h2", {
        id: "smallerrors"
      }, " FLAGS IN OUTPUT FEATURE CLASS"), React.createElement("div", {
        class: "flags-in-fc"
      }, this.list()), React.createElement("p", {
        class: "flag-note"
      }, "*There are detailed error messages associated with these flags, which have been added to your output feature class.", React.createElement("br", null), React.createElement("br", null), " Scroll to the far right of the attribute table, sort each of the 4 error fields in descending order, and work to either ", React.createElement("b", {
        style: {
          color: '#000000'
        }
      }, "eliminate"), " or ", React.createElement("b", {
...
var UniqueParcelDate = "51% or more records contain uniform PARCELDATE value.";
...
function (_React$Component4) {
  ...
  function BroadLevelErrors() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BroadLevelErrors).apply(this, arguments));
  }
  ...
  _createClass(BroadLevelErrors, [{
    ...
    value: function list() {
      ...
      for (var l in m) {
        ...
        if (Number(m[l]) == 0) {
          ...
          var lv = Number(m[l]).toLocaleString(navigator.language, {
            minimumFractionDigits: 0
          }) + " missing values in this field. Populate " + y + " for ALL records in the dataset.";
        }
      ...
      var orderArray = [["Expected_Taxroll_Year", "TAXROLLYEAR \"2023\" (Expected year value)"], ["Previous_Taxroll_Year", "TAXROLLYEAR \"2022\" (Previous year value)"], ["Future_Taxroll_Years", "TAXROLLYEAR \"2024 or 2025\" (Future year values)"], ["Other_Taxroll_Years", "TAXROLLYEAR (Other year values)"]]; // Determines the order to which the elements appear from top to bottom
    ...
    value: function render() {
      return React.createElement("div", null, React.createElement("h2", {
        id: "smallerrors"
      }, " GENERAL FILE ERRORS"), React.createElement("div", null, " ", this.list()));
    }
  }]);

  return BroadLevelErrors;
}(React.Component); ////This component renders the list of Taxroll errors items and sets up a tooltip on them to render on click.
