      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ResponsiveContainer,
              { className: "chartChart", width: "60%", height: 400 },
              React.createElement(
                BarChart,
                { data: this.data(),
        ...
        listArray.push(React.createElement(
          ...
          { key: i
            ...
            , html: React.createElement(
              ...
              React.createElement("div", { style: ds, dangerouslySetInnerHTML: { __html: "<br>" + "There were " + '<a id="reportedValue">' + p[i] + '</a>' + " errors found that relate to " + l.toLowerCase() + " attributes in the feature class. To review these errors, sort descending on the " + x + " field, which was added to your output feature class while executing the tool." } })
            ),
            position: "top",
            trigger: "click",
            animation: "fade",
        ...
        listArray.push(React.createElement(
          ...
          { key: i
            ...
            , html: React.createElement(
              ...
              React.createElement("div", { dangerouslySetInnerHTML: { __html: y } })
            ),
            position: "top",
            trigger: "click",
            animation: "fade",
